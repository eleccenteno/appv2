...
import { ArrowLeft, Radio, Sparkles, Lock } from 'lucide-react';
import { Button } from '@/components/ui/button';

export default function RetevisionView() {
      ...
      <div className="max-w-md w-full">
        <div className="flex items-center gap-3 mb-10">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-extrabold text-foreground tracking-tight">RETEVISION</h1>
              <p className="text-xs font-medium text-purple-600">Grupo Cellnex</p>
            </div>
          </div>
        </div>
        ...
        <div className="relative overflow-hidden rounded-2xl border border-border/50 bg-card p-8 text-center">
          ...
          <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-purple-500 to-violet-600 flex items-center justify-center mx-auto mb-4 shadow-lg shadow-purple-500/25 opacity-80">
          ...
          <p className="text-sm text-muted-foreground mt-2 leading-relaxed max-w-xs mx-auto">
            El módulo de RETEVISION se encuentra en fase de desarrollo. Estará disponible próximamente.
          </p>
          <div className="mt-6 inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-purple-500/10 text-purple-600 text-xs font-semibold">
