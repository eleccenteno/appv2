...
export default function InsyteView() {
      ...
      <div className="max-w-md w-full">
        ...
        <div className="flex items-center gap-3 mb-10">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-extrabold text-foreground tracking-tight">INSYTE</h1>
              <p className="text-xs font-medium text-blue-600">Instalaciones Integradas</p>
            </div>
          </div>
        </div>
        ...
        <div className="relative overflow-hidden rounded-2xl border border-border/50 bg-card p-8 text-center">
          ...
          <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center mx-auto mb-4 shadow-lg shadow-blue-500/25 opacity-80">
          ...
          <p className="text-sm text-muted-foreground mt-2 leading-relaxed max-w-xs mx-auto">
            El módulo de INSYTE se encuentra en fase de desarrollo. Estará disponible próximamente.
          </p>
          <div className="mt-6 inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-blue-500/10 text-blue-600 text-xs font-semibold">
